...
public class Advancement {
	...
	public String toString() {
		return "SimpleAdvancement{id=" + this.getId() + ", parent=" + (this.parent == null ? "null" : this.parent.getId()) + ", display=" + this.display + ", rewards=" + this.rewards + ", criteria=" + this.criteria + ", requirements="
	 ...
	 * 
	 * @return the {@code ITextComponent} that is shown in the chat message sent after this {@code Advancement} is completed. If this {@code Advancement} is {@linkplain #getDisplay() invisible}, then it consists simply of {@link #getId()}. Otherwise, it is the
	 *         {@linkplain DisplayInfo#getTitle() title} inside square brackets, colored by the {@linkplain FrameType#getFormat frame type}, and hovering over it shows the {@linkplain DisplayInfo#getDescription() description}.
	 */
