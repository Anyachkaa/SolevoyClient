...
public class Criterion {
	...
	/**
	 * Deserialize a <em>single</em> {@code Criterion} from {@code json}. The {@link ICriterionTrigger} is chosen by the {@code "trigger"} property of the object, which can then handle the optional {@code "conditions"} in the object. The {@code "conditions"},
