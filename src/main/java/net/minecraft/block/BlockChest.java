...
public class BlockChest extends BlockContainer {
	...
	/**
	 * Gets the chest inventory at the given location, returning null if the chest is blocked or there is no chest at that location. Handles large chests.
	 * 
	...
	/**
	 * Gets the chest inventory at the given location, returning null if there is no chest at that location or optionally if the chest is blocked. Handles large chests.
	 * 
	 * @param worldIn       The world
	 * @param pos           The position to check
	 * @param allowBlocking If false, then if the chest is blocked then <code>null</code> will be returned. If true, ignores blocking for the chest at the given position (but, due to <a href="https://bugs.mojang.com/browse/MC-99321">a bug</a>, still checks if
	 *                      the neighbor is blocked).
	 */
