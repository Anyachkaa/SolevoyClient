...
public class GuiCreateFlatWorld extends GuiScreen {
	...
	/**
	 * Would handler whether or not the edit and remove buttons are enabled, but is currently disabled and always disables the buttons (which are invisible anyways)
	 */
