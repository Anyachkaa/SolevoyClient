...
import ru.itskekoff.event.impl.EventRender2D;
...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        EventRender2D event = new EventRender2D(scaledresolution, partialTicks);
    ...
    /**
     * The handler tick for the ingame UI
     */
    public void updateTick() {
        ...
        if (this.mc.player != null) {
            ...
            } else if (!this.highlightingItemStack.isEmpty() && itemstack.getItem() == this.highlightingItemStack.getItem() && ItemStack.areItemStackTagsEqual(itemstack, this.highlightingItemStack)
