...
public class GuiMainMenu extends GuiScreen {
    ...
    /**
     * A random number between 0.0 and 1.0, used to determine if the title screen says <a href="https://minecraft.gamepedia.com/Menu_screen#Minceraft">Minceraft</a> instead of Minecraft. Set during construction; if the value is less than .0001, then Minceraft
     * is displayed.
     */
