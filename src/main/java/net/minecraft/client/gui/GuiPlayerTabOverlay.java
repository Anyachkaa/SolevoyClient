...
public class GuiPlayerTabOverlay extends Gui {
	...
	/**
	 * Called by GuiIngame to handler the information stored in the playerlist, does not actually render the list, however.
	 */
	...
	static class PlayerComparator implements Comparator<NetworkPlayerInfo> {
		...
		public int compare(NetworkPlayerInfo p_compare_1_, NetworkPlayerInfo p_compare_2_) {
			...
			return ComparisonChain.start().compareTrueFirst(p_compare_1_.getGameType() != GameType.SPECTATOR, p_compare_2_.getGameType() != GameType.SPECTATOR)
					.compare(scoreplayerteam != null ? scoreplayerteam.getName() : "", scoreplayerteam1 != null ? scoreplayerteam1.getName() : "").compare(p_compare_1_.getGameProfile().getName(), p_compare_2_.getGameProfile().getName()).result();
		}
	}
}
