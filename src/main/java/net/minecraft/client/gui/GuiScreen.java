...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
	...
	public boolean isAllowUserInput() {
		...
		return (BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().isPathing() && mc.player != null) || allowUserInput;
	}
	 ...
	 * Do not call after having already done other rendering, as it will draw over it.
	 * 
	 * @param tint Used to offset vertical position for the texture in options_background.png, if there is no world (i.e. if {@link #drawBackground} is called). In vanilla, this is always 0.
	 */
	...
	/**
	 * Called when the GUI is resized in order to handler the world and the resolution
	 */
