...
public enum ModelRotation implements IModelState, ITransformation {
	X0_Y0(0, 0), X0_Y90(0, 90), X0_Y180(0, 180), X0_Y270(0, 270), X90_Y0(90, 0), X90_Y90(90, 90), X90_Y180(90, 180), X90_Y270(90, 270), X180_Y0(180, 0), X180_Y90(180, 90), X180_Y180(180, 180), X180_Y270(180, 270), X270_Y0(270, 0), X270_Y90(270, 90),
	...
	public Optional<TRSRTransformation> apply(Optional<? extends IModelPart> p_apply_1_) {
		return Reflector.ForgeHooksClient_applyTransform_MR.exists() ? (Optional) Reflector.call(Reflector.ForgeHooksClient_applyTransform_MR, this, p_apply_1_)
				: (Optional) Reflector.call(Reflector.ForgeHooksClient_applyTransform_M4, this.getMatrix(), p_apply_1_);
	}
