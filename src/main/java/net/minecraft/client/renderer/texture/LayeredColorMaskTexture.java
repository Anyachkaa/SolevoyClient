				...
				while (true) {
					...
					try {
						...
						if (s != null) {
							...
							BufferedImage bufferedimage2 = Reflector.MinecraftForgeClient_getImageLayer.exists() ? (BufferedImage) Reflector.call(Reflector.MinecraftForgeClient_getImageLayer, new ResourceLocation(s), resourceManager)
