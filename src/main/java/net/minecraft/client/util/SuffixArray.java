...
public class SuffixArray<T> {
	/**
	 * A debug property (<code>SuffixArray.printComparisons</code>) that can be specified in the JVM arguments, that causes debug printing of comparisons as they happen.
	 */
	...
	/**
	 * A debug property (<code>SuffixArray.printArray</code>) that can be specified in the JVM arguments, that causes the full array to be printed ({@link #printArray()}) after calling {@link #generate()}
	 */
