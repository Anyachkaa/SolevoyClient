...
public class EntityList {
	...
	/**
	 * Gets the original name for the entity, used in versions prior to 1.11. This name is also used for translation strings.
	 * 
	...
	/**
	 * Gets the original name for the given entity type, used in versions prior to 1.11. Note that even entities added after 1.11 have old names as returned by this method.
	 * <p>
	 * This name is also used for translation strings; translate <code>"entity.$oldid.name"</code> (with <var>$oldid</var> being the result of this method) to get those names. Note that the name is upper-case in most situations.
	 * 
	...
	/**
	 * Checks if the given entity type matches the type of that entity, correctly handling behavior of players and lightning bolts.
	 * 
	...
	/**
	 * Checks if the given resource location matches a registered entity type, correctly handling behavior of players and lightning bols.
	 * 
