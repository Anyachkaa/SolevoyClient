...
public abstract class EntityLivingBase extends Entity {
	...
	/**
	 * Set immediately after this entity is attacked by another EntityLivingBase, allowing AI tasks to see who the attacker was and handle accordingly. Reset to null after 100 ticks have passed.
	 */
	...
	/**
	 * Constructs a knockback vector from the given direction ratio and magnitude and adds it to the entity's velocity. If it is on the ground (i.e. {@code this.onGround}), the Y-velocity is increased as well, clamping it to {@code
	 * .4}.
	 * 
	...
	private float getOverrideYaw() {
		if (this instanceof EntityPlayerSP && BaritoneAPI.getProvider().getBaritoneForPlayer((EntityPlayerSP) (Object) this) != null) {
	...
	protected void jump() {
		if (this instanceof EntityPlayerSP) {
			...
			if (baritone != null) {
				jumpRotationEvent = new RotationMoveEvent(RotationMoveEvent.Type.JUMP, this.rotationYaw);
		...
		if (this.isSprinting()) {
			float f = getOverrideYaw() * 0.017453292F;
