	...
	public void onLivingUpdate() {
		...
		if (this.world.isRemote && this.isInvisible()) {
			...
			if (this.hurtTime != 1 && this.ticksExisted % 1200 != 0) {
				...
				for (int l = 0; l < 16; ++l) {
					this.world.spawnParticle(EnumParticleTypes.CLOUD, this.posX + (this.rand.nextDouble() - 0.5D) * (double) this.width, this.posY + this.rand.nextDouble() * (double) this.height,
