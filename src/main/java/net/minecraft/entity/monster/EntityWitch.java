...
public class EntityWitch extends EntityMob implements IRangedAttackMob {
	...
	/**
	 * A timer that counts down until a witch finishes drinking a potion, at which time the held item (if it is a potion) will have its effects applied. Set to {@link ItemStack#getMaxItemUseDuration()}.
	 */
