...
public class InventoryPlayer implements IInventory {
	...
	public int findSlotMatchingUnusedItem(ItemStack p_194014_1_) {
		for (int i = 0; i < this.mainInventory.size(); ++i) {
			...
			if (!((ItemStack) this.mainInventory.get(i)).isEmpty() && this.stackEqualExact(p_194014_1_, this.mainInventory.get(i)) && !((ItemStack) this.mainInventory.get(i)).isItemDamaged() && !itemstack.isItemEnchanted()
	 ...
	 * {@linkplain net.minecraft.entity.passive.EntityOcelot ocelots} this may return the translation of <code>entity.Cat.name</code> if it is tamed. For {@linkplain net.minecraft.entity.item.EntityItem#getName() item entities}, this will attempt to return the
	 * name of the item in that item entity. In all cases other than players, the custom name will overrule this.</dd>
	 ...
	 * <dd>For most entities, this returns the result of {@link #getName()}, with {@linkplain net.minecraft.scoreboard.ScorePlayerTeam#formatPlayerName scoreboard formatting} and a {@linkplain net.minecraft.entity.Entity#getHoverEvent special hover
	 * event}.</dd>
