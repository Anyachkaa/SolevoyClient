...
public class Item {
	...
	/**
	 * Called each tick as long the item is on a player inventory. Uses by maps to check if is on a player hand and handler it's contents.
	 */
	...
	/**
	 * Returns whether this item is always allowed to edit the world. Forces {@link EntityPlayer#canPlayerEdit EntityPlayer#canPlayerEdit} to return {@code true}.
	 * 
