	...
	public static void spawnBonemealParticles(World worldIn, BlockPos pos, int amount) {
		...
		if (iblockstate.getMaterial() != Material.AIR) {
			for (int i = 0; i < amount; ++i) {
				...
				worldIn.spawnParticle(EnumParticleTypes.VILLAGER_HAPPY, (double) ((float) pos.getX() + itemRand.nextFloat()), (double) pos.getY() + (double) itemRand.nextFloat() * iblockstate.getBoundingBox(worldIn, pos).maxY,
