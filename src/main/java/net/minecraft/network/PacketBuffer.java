...
public class PacketBuffer extends ByteBuf {
	...
	/**
	 * Writes a compressed int to the buffer. The smallest number of bytes to fit the passed int will be written. Of each such byte only 7 bits will be used to describe the actual value since its most significant bit dictates whether the next byte is part of
	 * that same int. Micro-optimization for int values that are expected to have values below 128.
	 */
