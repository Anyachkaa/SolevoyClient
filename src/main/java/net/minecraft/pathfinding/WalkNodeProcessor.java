...
public class WalkNodeProcessor extends NodeProcessor {
	...
	/**
	 * This method is called when all nodes have been processed and PathEntity is created. {@link net.minecraft.world.pathfinder.WalkNodeProcessor WalkNodeProcessor} uses this to change its field
	...
	public PathPoint getStart() {
		...
		if (this.getCanSwim() && this.entity.isInWater()) {
			...
			for (blockpos = new BlockPos(this.entity); (this.blockaccess.getBlockState(blockpos).getMaterial() == Material.AIR || this.blockaccess.getBlockState(blockpos).getBlock().isPassable(this.blockaccess, blockpos))
	...
	public PathNodeType getPathNodeType(IBlockAccess p_193577_1_, int x, int y, int z, int xSize, int ySize, int zSize, boolean canOpenDoorsIn, boolean canEnterDoorsIn, EnumSet<PathNodeType> p_193577_10_, PathNodeType p_193577_11_,
