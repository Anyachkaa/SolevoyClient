...
public class ScorePlayerTeam extends Team {
	...
	/**
	 * Gets the prefix applied before the names of members of this team. Usually a single format code, but may be any text.
	 * 
	 * Note that the prefix is also used to determine the color for the "glowing" effect - see {@link net.minecraft.client.renderer.entity.Renderer#getTeamColor Renderer.getTeamColor}.
	 */
	...
	/**
	 * Gets the suffix applied after the names of members of this team. Usually a single reset format code, but may be any text.
	 */
