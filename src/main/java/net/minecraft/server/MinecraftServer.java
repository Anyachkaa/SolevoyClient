		...
		for (int j = 0; j < this.worlds.length; ++j) {
			...
			if (j == 0 || this.getAllowNether()) {
				...
				if (this.tickCounter % 20 == 0) {
					...
					this.playerList.sendPacketToAllPlayersInDimension(new SPacketTimeUpdate(worldserver.getTotalWorldTime(), worldserver.getWorldTime(), worldserver.getGameRules().getBoolean("doDaylightCycle")),
