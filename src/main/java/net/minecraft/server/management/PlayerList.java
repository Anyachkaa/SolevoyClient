...
public abstract class PlayerList {
	...
	public void initializeConnectionToPlayer(NetworkManager netManager, EntityPlayerMP playerIn) {
		...
		nethandlerplayserver.sendPacket(new SPacketJoinGame(playerIn.getEntityId(), playerIn.interactionManager.getGameType(), worldinfo.isHardcoreModeEnabled(), worldserver.provider.getDimensionType().getId(), worldserver.getDifficulty(),
	...
	/**
	 * Using player's dimension, handler the chunks around them
	 */
	...
	/**
	 * Destroys the given player entity and recreates another in the given dimension. Used when respawning after death or returning from the End
	 */
	...
	/**
	 * Sets the view distance used on the server. For the dedicated server, this is the <code>view-distance</code> value in server.properties. For the integrated server, this is the host's render distance (which may change).
	 */
