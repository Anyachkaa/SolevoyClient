...
public class UserListBansEntry extends UserListEntryBan<GameProfile> {
	...
	/**
	 * Convert a {@linkplain JsonObject JsonObject} into a {@linkplain GameProfile}. The json object must have {@code uuid} and {@code name} attributes or {@code null} will be returned.
	 */
