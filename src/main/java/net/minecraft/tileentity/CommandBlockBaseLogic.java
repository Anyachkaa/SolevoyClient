...
public abstract class CommandBlockBaseLogic implements ICommandSender {
	 ...
	 * <dt>{@link ICommandSender#getName() ICommandSender.getName()} and {@link net.minecraft.entity.Entity#getName() Entity.getName()}</dt>
	...
	/**
	 * Fills in information about the command block for the packet. entityId for the minecart version, and X/Y/Z for the traditional version
	 */
