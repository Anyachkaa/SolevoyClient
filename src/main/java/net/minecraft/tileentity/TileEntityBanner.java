...
public class TileEntityBanner extends TileEntity implements IWorldNameable {
	 ...
	 * <dd>However, note that <strong>the translation string may be invalid</strong>, as is the case for {@link TileEntityBanner TileEntityBanner} (always returns nonexistent translation code <code>banner</code> without a custom name),
