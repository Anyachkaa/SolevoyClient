...
public class TileEntityHopper extends TileEntityLockableLoot implements IHopper, ITickable {
	...
	/**
	 * Pull dropped {@link EntityItem EntityItem}s from the world above the hopper and items from any inventory attached to this hopper into the hopper's inventory.
	 * 
