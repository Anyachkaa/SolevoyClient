...
public class EntityDamageSource extends DamageSource {
	...
	public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
		...
		String s1 = s + ".item";
		return !itemstack.isEmpty() && itemstack.hasDisplayName() && I18n.canTranslate(s1) ? new TextComponentTranslation(s1, new Object[] { entityLivingBaseIn.getDisplayName(), this.damageSourceEntity.getDisplayName(), itemstack.getTextComponent() })
