...
public class TextComponentScore extends TextComponentBase {
	...
	/**
	 * Sets the value that is displayed for the score. Generally, you do not want to call this as the score is resolved automatically. (If you want to manually set text, use a {@link TextComponentString})
	 */
