...
public abstract class WorldProvider {
	 ...
	 * 
	 * @see <a href="https://github.com/ModCoderPack/MCPBot-Issues/issues/330">https://github.com/ModCoderPack/MCPBot- Issues/issues/330</a>
	 */
	...
	/**
	 * Creates a new {@link BiomeProvider} for the WorldProvider, and also sets the values of {@link #hasSkylight} and {@link #hasNoSky} appropriately.
	 * 
	...
	public IChunkGenerator createChunkGenerator() {
		if (this.terrainType == WorldType.FLAT) {
			...
			return this.terrainType == WorldType.CUSTOMIZED ? new ChunkGeneratorOverworld(this.world, this.world.getSeed(), this.world.getWorldInfo().isMapFeaturesEnabled(), this.generatorSettings)
	...
	/**
	 * Called when the world is updating entities. Only used in WorldProviderEnd to handler the DragonFightManager in Vanilla.
	 */
