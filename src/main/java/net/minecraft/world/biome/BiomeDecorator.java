...
public class BiomeDecorator {
	...
	/**
	 * Standard ore generation helper. Vanilla uses this to generate most ores. The main difference between this and {@link #genStandardOre2} is that this takes min and max heights, while genStandardOre2 takes center and spread.
	 */
	...
	/**
	 * Standard ore generation helper. Vanilla uses this to generate Lapis Lazuli. The main difference between this and {@link #genStandardOre1} is that this takes takes center and spread, while genStandardOre1 takes min and max heights.
	 */
