...
public class Chunk {
	...
	/**
	 * Checks the height of a block next to a sky-visible block and schedules a lighting handler as necessary.
	 */
	...
	/**
	 * Called once-per-chunk-per-tick, and advances the round-robin relight check index by up to 8 blocks at a time. In a worst-case scenario, can potentially take up to 25.6 seconds, calculated via (4096/8)/20, to re-check all blocks in a chunk, which may
	 * explain lagging light updates on initial world generation.
	 */
