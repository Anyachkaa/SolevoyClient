...
public class ExtendedBlockStorage {
	 ...
	 * 
	 * Will be null if the provider for the world the chunk containing this block storage does not {@linkplain net.minecraft.world.WorldProvider#hasSkylight have skylight}.
	 */
