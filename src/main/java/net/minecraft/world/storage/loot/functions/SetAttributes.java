...
public class SetAttributes extends LootFunction {
	...
	public ItemStack apply(ItemStack stack, Random rand, LootContext context) {
		for (Modifier setattributes$modifier : this.modifiers) {
			...
			stack.addAttributeModifier(setattributes$modifier.attributeName, new AttributeModifier(uuid, setattributes$modifier.modifierName, (double) setattributes$modifier.amount.generateFloat(rand), setattributes$modifier.operation),
					entityequipmentslot);
		}
