...
public class BindComponent extends Component {
    ...
    public BindComponent(ModuleComponent button, int offset) {
        this.parent = button;
    ...
    public void renderComponent() {
        ...
        Minecraft.getMinecraft().getMain_2().drawStringWithShadow(binding ? "Press a key..." : ("Key bind: " + Keyboard.getKeyName(this.parent.mod.getKey())), (parent.parent.getX() + 7) * 2, (parent.parent.getY() + offset + 2) * 2 + 5, -1);
        GL11.glPopMatrix();
    }
