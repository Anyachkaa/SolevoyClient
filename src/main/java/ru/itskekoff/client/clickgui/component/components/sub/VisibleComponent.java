...
public class VisibleComponent extends Component {
    ...
    public VisibleComponent(ModuleComponent button, Module mod, int offset) {
        this.parent = button;
        this.mod = mod;
    ...
    public void renderComponent() {
        ...
        Minecraft.getMinecraft().getMain_2().drawStringWithShadow("Visible: " + mod.visible, (parent.parent.getX() + 7) * 2, (parent.parent.getY() + offset + 2) * 2 + 5, -1);
        GL11.glPopMatrix();
    }
